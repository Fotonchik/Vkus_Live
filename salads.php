...
<div class="container-fluid">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/salads/sal.jpg" class="d-block w-100">
        
      </div>
        <div class="carousel-item">
        <img src="img/salads/ded.jpg" class="d-block w-100">
        
      </div>
        <div class="carousel-item">
        <img src="img/salads/waterlemon.png" class="d-block w-100">
...
<?php
include('dbconnect.php');
$result = $mysqli->query('SELECT * FROM `formula` WHERE id IN(4,5)');
$div = "<div id='row'>";
$k = 1;
