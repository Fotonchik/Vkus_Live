  ...
  <div id="carouselExample" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/hot/hash1.jpg" class="d-block w-100">
        
      </div>
        <div class="carousel-item">
        <img src="img/hot/hot.jpg" class="d-block w-100">
              </div>
        <div class="carousel-item">
        <img src="img/hot/lodochki.jpg" class="d-block w-100">
              </div>
    </div>
  </div>
...
$div .='<div class = "col" >
<div class="tour">';
    $id = $myrow[id]; $div.='<p>'.$myrow[programm].'</p>';
    $div.='</div></div>';
    $div.='</div>';
    echo $div;
    ?>
...
<?php
include('dbconnect.php');
$result=$mysqli->query("SELECT * FROM `formula`  WHERE id IN(7,8) ");
$div = "<div id='row'>";
$k = 1;
